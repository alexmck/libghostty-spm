...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/alexmck/libghostty-spm/releases/download/1.1.6-termside.1/GhosttyKit.xcframework.zip",
            checksum: "c286b0b89a8cd9d1f92f2837aa2b5daa64fb8210060fedf0b90e411c9b18bd89"
        ),
        .testTarget(
            name: "GhosttyKitTest",
